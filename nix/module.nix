...
in
{
  options.programs.hyprpanel = {
    ...
    settings = {
      ...
      bar.customModules.custom1.icon = mkStrOption "";
      bar.customModules.custom1.label = mkStrOption "";
      bar.customModules.custom1.showLabel = mkBoolOption false;
      bar.customModules.custom1.leftClick = mkStrOption "";
      bar.customModules.custom1.middleClick = mkStrOption "";
      bar.customModules.custom1.rightClick = mkStrOption "";
      bar.customModules.custom1.scrollDown = mkStrOption "";
      bar.customModules.custom1.scrollUp = mkStrOption "";
      bar.customModules.custom2.icon = mkStrOption "";
      bar.customModules.custom2.label = mkStrOption "";
      bar.customModules.custom2.showLabel = mkBoolOption false;
      bar.customModules.custom2.leftClick = mkStrOption "";
      bar.customModules.custom2.middleClick = mkStrOption "";
      bar.customModules.custom2.rightClick = mkStrOption "";
      bar.customModules.custom2.scrollDown = mkStrOption "";
      bar.customModules.custom2.scrollUp = mkStrOption "";
      bar.customModules.custom3.icon = mkStrOption "";
      bar.customModules.custom3.label = mkStrOption "";
      bar.customModules.custom3.showLabel = mkBoolOption false;
      bar.customModules.custom3.leftClick = mkStrOption "";
      bar.customModules.custom3.middleClick = mkStrOption "";
      bar.customModules.custom3.rightClick = mkStrOption "";
      bar.customModules.custom3.scrollDown = mkStrOption "";
      bar.customModules.custom3.scrollUp = mkStrOption "";
      bar.customModules.custom4.icon = mkStrOption "";
      bar.customModules.custom4.label = mkStrOption "";
      bar.customModules.custom4.showLabel = mkBoolOption false;
      bar.customModules.custom4.leftClick = mkStrOption "";
      bar.customModules.custom4.middleClick = mkStrOption "";
      bar.customModules.custom4.rightClick = mkStrOption "";
      bar.customModules.custom4.scrollDown = mkStrOption "";
      bar.customModules.custom4.scrollUp = mkStrOption "";
